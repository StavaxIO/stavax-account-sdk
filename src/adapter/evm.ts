...
export function setupStavaxProvider(stavaxAccount: StavaxAccount, customProvider?: CustomProviderFn) {
    window?.addEventListener('eip6963:requestProvider', () => announceProvider(stavaxAccount, customProvider));
    announceProvider(stavaxAccount, customProvider);
}
